...
export default function MarketplaceScreen() {
  ...
  const getConditionStyle = (condition: string) => {
    switch (condition) {
      case 'new': return { backgroundColor: Colors.success + '20' };
      case 'excellent': return { backgroundColor: Colors.primary + '20' };
      case 'used': return { backgroundColor: Colors.warning + '20' };
  ...
  const getConditionTextStyle = (condition: string) => {
    switch (condition) {
      case 'new': return { color: Colors.success };
      case 'excellent': return { color: Colors.primary };
      case 'used': return { color: Colors.warning };
      default: return { color: Colors.neutral[600] };
    }
  };
